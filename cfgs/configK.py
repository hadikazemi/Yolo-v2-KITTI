...
############################
multi_scale_inp_size = [np.array([1230, 366], dtype=np.int),
                        # np.array([366, 1230], dtype=np.int),
                        # np.array([370, 1242], dtype=np.int),
...
inp_size = np.array([1230, 366], dtype=np.int)   # w, h
...
DATA_DIR = '/media/hadi/HHD 6TB/Datasets/Kitti/training'
